...
const Footer: Component = () => {
  return (
    <>
      {/* <footer class="w-full max-w-[85rem] py-4 lg:py-4 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="text-center">
    <div>
    <img src={logo.src} alt="Goodpluck" class="h-8 w-5 mx-auto" />
    </div>
    <div class="mt-3 space-x-2">
    <a class="inline-flex justify-center items-center w-6 h-6 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" href="#">
          ...
          <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div class="flex justify-between items-center">
              <p class="text-sm text-gray-400">
                © 2022 GoodPluck. All rights reserved.
              </p>
            </div>
            {/* <!-- End Col --> */}
