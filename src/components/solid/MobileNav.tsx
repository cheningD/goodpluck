...
const AccountIcon = (
  <IconMdiAccountCircleOutline class="w-6 h-6"/>
);
...
const ChevronDownIcon = (
  <IconMdiChevronDown class="w-4 h-4" />
); 

const FacebookIcon = (
  <IconMdiFacebook class="w-6 h-6" />
);
...
// );
const InstaIcon = (
  <IconMdiInstagram class="w-6 h-6" />
);
    ...
    <>
      <nav class="flex flex-col">
        ...
        <div class="justify-self-end pr-2 pt-1">
          ...
          <a href="" class="text-sm uppercase font-semibold text-orange-800">Login</a>
        </div>
        ...
        <ul class="font-medium text-gray-800 hover:text-gray-600 transition-all duration-300 md:block w-full flex flex-col border-t-2 border-dashed border-gray-100 px-6">
          ...
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Produce</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Meat & Seafood</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Dairy & Eggs</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Bakery</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Easy Meals</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Drinks</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Pantry</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">New & Seasonal</a></li>
         </ul>
         ...
         <ul class="font-medium text-gray-800 hover:text-gray-600 transition-all duration-300 md:block w-full flex flex-col border-t-2 border-dashed border-gray-100 px-6">
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">About</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Recipes</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Kitchen</a></li>
          <li class="flex gap-x-1 border-b-2 border-dashed border-gray-100 py-2"><a href="">Buy a Gift Card</a></li>
         </ul>
